...
CREATE TABLE `users` (
    ...
    `role` ENUM('ADMIN', 'AUTHOR', 'EDITOR', 'GUEST') NOT NULL DEFAULT 'EDITOR',
...
CREATE TABLE `customers` (
    ...
    UNIQUE INDEX `customers_displayName_key`(`displayName`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    `status` ENUM('PENDING', 'PAID', 'CANCEL', 'FAILED', 'DELIVERING', 'COMPLETED') NOT NULL DEFAULT 'PENDING',
    `paymentStatus` ENUM('PENDING', 'PAID', 'CANCEL', 'FAILED') NOT NULL DEFAULT 'PENDING',
    ...
    UNIQUE INDEX `orders_paymentIntent_key`(`paymentIntent`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
